...
// Keep the instanced Alternator model aligned with its live block state
public class AlternatorVisual extends KineticBlockEntityVisual<AlternatorBlockEntity> {
    ...
    // Initialize the alternator visual
    public AlternatorVisual(VisualizationContext ctx, AlternatorBlockEntity blockEntity, float partialTick) {
